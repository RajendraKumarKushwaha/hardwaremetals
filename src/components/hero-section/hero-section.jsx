...
export function HeroSection() {
    return (
        ...
        <div className="bg-[url('/img/bg.jpg')] h-screen bg-cover bg-center bg-no-repeat w-full">
            <div className="md:flex text-white mt-20 md:justify-between md:items-center md:px-20 px-7 h-screen">
                <div className="md:text-6xl  py-16 text-3xl font-semibold md:w-[45%]">
                ...
                <div>
                    ...
                    <div className="mt-5 space-y-2 font-semibold">
                        <button className=" py-3 px-6 rounded md:ml-8 cursor-pointer duration-500 bg-cyan-900   hover:bg-white hover:text-black">
