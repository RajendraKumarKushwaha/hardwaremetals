    ...
    return (
        <div className="pt-24 md:px-20 pb-16 px-7">
            <div className="flex flex-col text-[#181818]  justify-center items-center ">
                ...
                <p className=" text-[#181818] text-xl">Home / Windows</p>
            </div>
            {windowsData.map((category, index) => (
                <div key={index} className="pt-16">
                    <h2 className="md:text-4xl text-3xl md:text-start text-center font-bold text-[#181818] mb-8">{category.category}</h2>
