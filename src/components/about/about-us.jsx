        ...
        <div className="bg-[url('/img/bg-white.jpg')] h-auto md:px-20 px-7 bg-cover bg-center bg-no-repeat w-full">
          ...
          <div className="md:mt-20 mt-10">
            <div className="md:flex pt-8 justify-between items-center space-y-6">
              <div className="md:w-[48%] w-full">
                <p className="text-black font-semibold md:text-3xl text-2xl mb-3 text-center">
          ...
          <div className="md:mt-20 mt-10 ">
            <div className="flex pt-8 justify-between items-center md:flex-row flex-col-reverse space-y-6">
              <div className="md:w-[48%] w-full">
                <p className="text-gray-600 text-[17px] leading-7 font-semibold md:text-start text-center">
                  <span className="text-black text-bold">Mr. Ritesh Chaurasiya</span>, the son of{" "}
                  <span className="text-black text-bold">Mr. Ramesh Chaurasiya</span>, is now successfully running{" "}
                  <span className="text-black text-bold">Urmila Metals</span> and leading its growth into new horizons. With a solid foundation built by his father and a keen sense of innovation, Mr. Ritesh brings fresh perspectives while maintaining the commitment to quality and craftsmanship that the business is known for.
                </p>
                <p className="text-gray-600 text-[17px] leading-7 font-semibold mt-8 md:text-start text-center">
