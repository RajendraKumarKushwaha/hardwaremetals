export function AboutUs() {
  return (
    <div className="flex flex-col min-h-screen  "> {/* Set flex and min-height to 100vh */}
      <div className="bg-[url('/img/bg-white.jpg')] py-16 h-auto md:px-20 px-7 bg-cover bg-center bg-no-repeat w-full">
          ...
          <div className="md:flex pt-8 justify-between space-y-6">
            <div className="md:w-[48%] w-full">
              <div className="text-center">
                <img src="/img/Bhaiyaji-.jpeg" alt="owner" className="" />
                <p className="mt-2 text-[16px] text-[#83827f]"> Mr. Ramesh Chaurasiya</p>
                <p className="mt-2 text-sm text-gray-600">Founder & Managing Director</p>
              </div>
            </div>
            <div className="md:w-[48%] w-full">
              <p className="text-[#83827f] text-[17px] leading-7  md:text-start text-center">
              ...
              <p className="text-[#83827f] text-[17px] leading-7  mt-8 md:text-start text-center">
        ...
        <div className="md:mt-20 mt-10 ">
          <div className="flex pt-8 justify-between  md:flex-row flex-col-reverse space-y-6">
            <div className="md:w-[48%] w-full">
              <p className="text-[#83827f] text-[17px] leading-7  md:text-start text-center">
            ...
            <div className="md:w-[48%] w-full">
            <div className="text-center">
                <img src="/img/ritesh-.png" alt="owner" className="w-full" />
                <p className="mt-2 text-[16px] text-[#83827f]"> Mr. Ritesh Chaurasiya</p>
                <p className="mt-2 text-sm text-gray-600">Managing Director</p>
              </div>
            </div>
          </div>
        </div>
